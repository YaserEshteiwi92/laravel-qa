<nav x-data="{ open: false }" class="bg-white border-b border-gray-100 sticky top-0">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <!-- Navigation Links -->
                <div class="hidden space-x-8 rtl:space-x-reverse sm:-my-px ltr:sm:ml-10 rtl:sm:mr-10 sm:flex">
                    @auth
                ...
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button
                            ...
                            <div class="capitalize">{{ LaravelLocalization::getCurrentLocaleNative() }}</div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-notification-nav screen="mobile" />
            @else
            <x-responsive-nav-link :href="route('questions.index')" :active="request()->routeIs('questions.index')">
                {{ __('Questions') }}
            </x-responsive-nav-link>
